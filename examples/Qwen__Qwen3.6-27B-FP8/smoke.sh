...
# Smoke test + sweep for Qwen/Qwen3.6-27B-FP8
# Assumes vllm server is already running (use --no-server).
#
# Usage:
#   bash examples/smoke_qwen27b_fp8.sh
#   bash examples/smoke_qwen27b_fp8.sh --port 8081
#   bash examples/smoke_qwen27b_fp8.sh --port 8081 --rates "16.0"
